...
for irow in range(1):
	S1 = ROW()
	S1.name = 'S1'
	S1.X1=[-67,-67]				### INLET METAL ANGLES: [Hub,Casing]
	S1.X2=[67,67]				### EXIT METAL ANGLES: [Hub,Casing]
	...
	R1 = ROW()
	R1.name = 'R1'
	R1.X1=[0,0]				### INLET METAL ANGLES: [Hub,Casing]
	R1.X2=[-68,-68]				### EXIT METAL ANGLES: [Hub,Casing]
...
plt.savefig('Mesh.png', dpi=2000, bbox_inches='tight')
plt.show()
